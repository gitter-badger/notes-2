...
| Category                                          | Progess                        |
|---------------------------------------------------|--------------------------------|
| [Functions](functions/README.md)                  | 1% (24/1955 functions)         |
| [Global variables (read-only)](rdata/README.md)   | 19% (5656/28372 bytes)         |
...
| [Storm ordinals](storm.md)                        | 29% (17/58 functions)          |
