...
| [init.cpp](init.md)             | `0x47AE20`    | `0x47AE3F`  | 12% (4/32 bytes)         |
...
| [palette.cpp](palette.md)       | `0x47F16C`    | `0x47F1AF`  | 5% (4/68 bytes)          |
| [path.cpp](path.md)             | `0x47F1B0`    | `0x47F1BF`  | 0% (0/16 bytes)          |
| [pfile.cpp](pfile.md)           | `0x47F1C0`    | `0x47F203`  | 5% (4/68 bytes)          |
| [player.cpp](player.md)         | `0x47F204`    | `0x47F22F`  | 9% (4/44 bytes)          |
| [plrmsg.cpp](plrmsg.md)         | `0x47F230`    | `0x47F237`  | 0% (0/8 bytes)           |
| [scrollrt.cpp](scrollrt.md)     | `0x47F238`    | `0x47F24B`  | 20% (4/20 bytes)         |
| [sound.cpp](sound.md)           | `0x47F24C`    | `0x4802AB`  | 0% (4/4192 bytes)        |
